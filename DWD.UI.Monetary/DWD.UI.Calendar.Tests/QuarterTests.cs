...
public class QuarterTests
{
    ...
    public void ShouldConstructFromYearAndQuarter(short year, short quarter, int expectedYear, int expectedQuarter)
    {
    ...
    public void PreviousShouldProducePredecessorQuarter(short year, short quarter, int expectedYear, int expectedQuarter)
    {
    ...
    [InlineData(2020, -1)]
    [InlineData(2020, 5)]
    public void QuarterShouldRejectInvalidConstruction(short year, short quarterNumber) =>
