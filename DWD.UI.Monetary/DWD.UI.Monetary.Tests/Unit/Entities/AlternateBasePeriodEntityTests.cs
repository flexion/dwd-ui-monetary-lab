...
public class AlternateBasePeriodEntityTests
{
    [Theory]
    [ClassData(typeof(AlternateBasePeriodConstructorTestData))]
    public void TestAlternateBasePeriodConstructor_ClassData(string testDescription, DateTime initialClaimDate, Collection<Quarter> expectedQuarters)
    {
        // Arrange
...
public class AlternateBasePeriodConstructorTestData : IEnumerable<object[]>
{
    public IEnumerator<object[]> GetEnumerator()
    {
        ...
        {
            "BasePeriodConstructor_ShouldReturnCorrectAlternateQuartersForClaimDate_WhenValidClaimDate",
        ...
        yield return new object[]
        {
            "BasePeriodConstructor_ShouldReturnPriorAltBaseQuarters_WhenClaimDatePriorToFirstSundayOfQuarter",
        ...
        yield return new object[]
        {
            "BasePeriodConstructor_ShouldReturnCurrentAltBaseQuarters_WhenClaimDateOnFirstSundayOfQuarter",
        ...
        yield return new object[]
        {
            "BasePeriodConstructor_ShouldReturnCurrentAltBaseQuarters_WhenClaimDateAfterFirstSundayOfQuarter",
